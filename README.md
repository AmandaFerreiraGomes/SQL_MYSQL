![image](https://user-images.githubusercontent.com/50182271/127007611-9c1c9766-5ba5-4099-8fff-b310763e1b31.png)
  ...
  Meu portifólio com implementações de códigos em SQL no MYSQL(SGBDR), de acordo com o que foi aprendido no curso da ALURA (INTRODUÇÃO AO SQL COM MYSQL: MANIPULE E CONSULTE DADOS). Neste repositório estão inseridos códigos e exemplos de implementações as quais foram feitas durante o curso.
