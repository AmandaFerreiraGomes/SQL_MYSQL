...
UPDATE tbProduto SET SABOR = 'Cítricos' WHERE SABOR = 'Limão'; # (2)
...
SELECT * FROM tbProduto WHERE SABOR = 'LIMÃO'; # (3)

/* mostra todos os produtos cujo sabor é cítricos. */
SELECT * FROM tbProduto WHERE SABOR = 'CÍTRICOS'; # (4)
...
SELECT * FROM tbProduto WHERE PRECO_LISTA BETWEEN 16.007 AND 16.009; # (5)
